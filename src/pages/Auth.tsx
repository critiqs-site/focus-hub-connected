      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          <div className="relative mb-6 animate-scale-in">
            <img src={logoFavicon} alt="CRITIQS logo" className="mx-auto w-40 h-40 object-contain drop-shadow-2xl" style={{ mixBlendMode: 'screen' }}Mode: 'screen' }} />
          </div>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-4 animate-scale-in">
          <img src={logoFavicon} alt="CRITIQS logo" className="w-24 h-24 object-conta" style={{ mixBlendMode: 'screen' }}ix-blend-lighten" />
        </div>
